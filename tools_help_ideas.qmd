...
format:  
  html:
    ...
    css: styles.css
    toc: false # if # are not in file. this makes it so the render html does not save space for a toc. when true there is an empty right space reserve for toc making the content page smaller
    # cont of toc: for some reason individual toc settings does not work.
    # for some reason, when # are use in file. toc automatically appears no matter the settings for it. 
    # I might not be using the toc settings the right way. 
